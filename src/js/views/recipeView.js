...
const createIngredient = ingredient => `
    ...
    <div class="recipe__count">${formatCount(Math.round(ingredient.amount * 100) / 100)}</div>
...
export const renderRecipe = (recipe, isLiked) => {
    ...
    <div class="recipe__details">
        <div class="recipe__info">
            ...
            <span class="recipe__info-data recipe__info-data--minutes">${eval(recipe.prepTime+recipe.cookTime)}</span>
...
export const updateServings = recipe => {
    // Update Servings
    //elements.recipeServings.textContent = recipe.servings;
